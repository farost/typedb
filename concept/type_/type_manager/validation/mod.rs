...
use crate::{
    ...
    type_::{
        annotation::{
            AnnotationCardinality, AnnotationCategory, AnnotationRange, AnnotationRegex, AnnotationValues,
        },
...
pub enum SchemaValidationError {
    ...
    SpecialisedRelatesIsNotAbstract(Label<'static>, Label<'static>, Label<'static>),
    ...
    ValueTypeIsNotKeyableForUniqueConstraintOfKeyAnnotationDeclaredOnOwns(Label<'static>, Label<'static>, Option<ValueType>),
    ValueTypeIsNotKeyableForUniqueConstraintOfUniqueAnnotationDeclaredOnOwns(Label<'static>, Label<'static>, Option<ValueType>),
    CannotSetAnnotationToInterfaceBecauseItsConstraintIsNotNarrowedByItsCapabilityConstraint(Label<'static>, ConstraintError),
    ...
    CannotRedeclareConstraintOnSubtypeWithoutSpecialisation(Kind, Label<'static>, Label<'static>, ConstraintDescription),
...
impl Error for SchemaValidationError {
    fn source(&self) -> Option<&(dyn Error + 'static)> {
        match self {
            ...
            Self::SpecialisedRelatesIsNotAbstract(_, _, _) => None,
            ...
            Self::CannotSetAnnotationToInterfaceBecauseItsConstraintIsNotNarrowedByItsCapabilityConstraint(_, _) => None,
            Self::CannotSetAnnotationToCapabilityBecauseItsConstraintDoesNotNarrowItsInterfaceConstraint(_, _, _) => None,
